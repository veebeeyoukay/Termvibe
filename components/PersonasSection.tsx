  ...
  const personas = [
    {
      ...
      bestFor: "Complete beginners, bootcamp grads, career switchers",
      personality: "Encouraging, thorough, never rushes",
    ...
    },
    {
      ...
      bestFor: "Experimental learners, tinkerers, DevOps-curious",
    ...
    },
    {
      ...
      bestFor: "Self-taught devs, CS students, confidence builders",
      personality: "Positive, motivating, celebrates wins",
    ...
    },
    {
      ...
      bestFor: "Efficient learners, experienced devs learning CLI",
      personality: "Direct, no fluff, gets to the point",
